...
$db = $database->getConnection();
  ...
  // query products
  $stmt = $user->user_readMovieTransactionPaging($from_record_num, $records_per_page,$user_g_id,$status);
  $num = $stmt->rowCount();
  ...
  if($num>0){
      ...
      // include paging
      $total_rows=$user->user_readMovieTransactionCount($user_g_id,$status);
      $page_url="{$home_url}users/user_readMovieTransactionPaging.php?";
