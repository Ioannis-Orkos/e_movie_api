...
// query products
$stmt =  $movies->readPaging_movies_forUsers($from_record_num, $records_per_page,$mType,$mGenre,$mSort,$mYear,$mOrder);
$num =   $stmt->rowCount();
...
if($num>0){
    ...
    // include paging
    $total_rows= $movies->readPagingcount_movies_forUsers($mType,$mGenre,$mSort,$mYear,$mOrder);
    $page_url="{$home_url}movies/movie_read_byPaging.php?";
