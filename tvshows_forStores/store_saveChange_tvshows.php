...
include_once '../objects/store.php';
  ...
  $mids_add = isset($_POST["tvids_add"])?$_POST["tvids_add"]:"";
  $mids_del = isset($_POST["tvids_del"])?$_POST["tvids_del"]:"";
  ...
  if(!empty($mids_add)){
    ...
    $response = $store->store_add_tvshow($query_data_add,$sgi);
  }
