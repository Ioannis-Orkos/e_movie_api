...
$movies = new Tvshow($db);
  ...
  if(!empty($mSGID)){
      ...
      // query
      $stmt =  $movies->readPaging_searchtvshow_forStores($mSGID,$from_record_num, $records_per_page,$mType,$mGenre,$mSort,$mYear,$mOrder,$mMyMovie,$search);
      $num =   $stmt->rowCount();
      ...
      if($num>0){
          ...
          // include pagination
          $total_rows= $movies->readPagingcount_searchtvshow_forStores($mSGID,$mType,$mGenre,$mSort,$mYear,$mOrder,$mMyMovie,$search);
