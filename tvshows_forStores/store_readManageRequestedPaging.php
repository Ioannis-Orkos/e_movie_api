...
// query products
$stmt = $movies->store_readRequestedTvshowsPaging($from_record_num, $records_per_page,$user_g_id,$status);
$num = $stmt->rowCount();
...
if($num>0){
    ...
    // include paging
    $total_rows=$movies->store_readRequestedTvshowsCount($user_g_id,$status);
